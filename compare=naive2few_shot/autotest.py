...
COMMANDS: list[str] = [
    ...
    f'"{PYTHON_EXE}" "{TEXTUAL_SCRIPT}" --scenario besides_edges --variant naive --repeats 20',
    ...
    f'"{PYTHON_EXE}" "{TEXTUAL_SCRIPT}" --scenario plain_grounds --variant naive --repeats 20',
    ...
    #f'"{PYTHON_EXE}" "{MULTIMODAL_SCRIPT}" --scenario far_edge --variant multifewshot --fewshot-base narrow --repeats 20',
    #f'"{PYTHON_EXE}" "{MULTIMODAL_SCRIPT}" --scenario far_edge --variant multifewshot --fewshot-base balanced --repeats 20',
    #f'"{PYTHON_EXE}" "{MULTIMODAL_SCRIPT}" --scenario far_edge --variant multifewshot --fewshot-base far_edge_bias --repeats 20',
]
